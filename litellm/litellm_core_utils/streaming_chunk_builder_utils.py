...
class ChunkProcessor:
    ...
    def _calculate_usage_per_chunk(
        ...
        for chunk in chunks:
            ...
            if usage_chunk is not None:
                ...
                # Keep a provider-reported cost (e.g. OpenRouter sends it on the
                # final usage chunk) so it survives chunk aggregation.
    ...
    def calculate_usage(
        ...
        if calculated_usage_per_chunk.get("cost") is not None:
